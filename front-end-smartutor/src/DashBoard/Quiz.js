  ...
  return (
    ...
    `}
      ...
      {loading &&
       ...
       <LoaderScreen mesg="It may take 1-2 min to evaluate your answers" />
     </div>
       }
      <div style={blurStyle}>
            ...
            <Card style={{ width: '100%'}}>
              <Card.Header className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center" style={{ color: 'blue', cursor: 'pointer' }}>
                  <FaArrowLeft style={{ fontSize: '20px' }}  onClick={() => navigate('/dashboard', { state: { studyPlan } })} />
              ...
              <Card.Body style={{ marginLeft: '20%' }}>
                {quizSubmitted && (
                  <div style={{ marginLeft: '50%' }}>
                    <p style={{ fontSize: '20px', color: 'black', fontWeight: 'bold' }}>
                      You have <span style={{ color: correctAnswers > 0 ? 'green' : 'red' }}>{correctAnswers}</span> out of {questions.length} Questions correct!
                    </p>
                  </div>
                )}
                <ol>
                ...
                {quizSubmitted && (
                  <>
                    <Button variant="primary" style={{marginBottom:'15%'}} onClick={() => navigate('/dashboard', { state: { studyPlan } })}>
