...
<Card className="user-card-full" style={{ width: '90%'}}>
  <Card.Body>
    ...
    <MDBProgress height='20'>
      <MDBProgressBar width={percentage} valuemin={0} valuemax={100} style={{backgroundColor:'#f66b1d',color:'white'}}  bgColor='#1f5692'>
      {percentage}%
      </MDBProgressBar>
...
<Card className="user-card-full" style={{ width: '90%', marginBottom: '5%' }}>
  <Card.Body>
    ...
    {members && members == 1 &&  <Button variant="primary" style={{backgroundColor:'#f66b1d' ,borderColor:'#f66b1d'}} onClick={handleDelete}>Delete Study Plan</Button>}
   

{members && members > 1 && 
  <Button variant="primary" style={{backgroundColor:'#f66b1d' ,borderColor:'#f66b1d'}} onClick={handleLeave}>Leave Study Plan</Button>
}
...
<Button variant="primary" style={{backgroundColor:'#f66b1d' ,borderColor:'#f66b1d'}} onClick={completeStudyPlan}>Completed StudyPlan</Button>
    </Col>
