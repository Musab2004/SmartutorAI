 ...
 // Empty dependency array means this effect runs once on component mount
  ...
  const Recommendations = async () => {
    try {
      ...
      const response = await userService.get(`/api/recommendedstudyplans/`,{     params: {user_id: userData.pk,
      }});
  ...
  <section style={{marginTop:'0px',borderRadius:'30px',marginTop:'0px',backgroundColor:'#e1efff'}} >
<div>

<div style={{marginTop:'100px'}}>
<h style={{ textAlign: 'left', fontWeight: 'bold', fontSize: '24px',marginTop:'100px',color:'#1f5692',fontStyle: 'italic'  }}>Recommended Study Plans</h>
</div>
</div>
<CardSlider cards={posts} />
          ...
          <section  style={{marginTop:'0px',marginTop:'50px',marginBottom:'50px',backgroundColor:'#e1efff'}} >
          <h style={{ textAlign: 'left', fontWeight: 'bold', fontSize: '24px',color:'#1f5692',fontStyle: 'italic'   }}>Popular Study Plans</h>
         
<CardSlider cards={posts} />

          </section>
          <h style={{ textAlign: 'left', fontWeight: 'bold', fontSize: '24px',color:'#1f5692',fontStyle: 'italic'    }}>Latest Study Plans</h>
          <section className="bg-light" style={{marginTop:'0px'}} >
