 ...
 // This will run only once, when the component mounts
  ...
  return (
    <div>
      ...
      <div className="d-flex flex-wrap" style={{marginLeft:'10%'}}>
        {currentStudyPlans.map((studyPlan, index) => (
             ...
             >
              <Card.Img variant="top"  style={{ width: '100%', height: '150px' }}src={baseURL+studyPlan.image} />
              <Card.Body>
    ...
    <Row>
      ...
      <Card.Img variant="top" src={baseURL+ selectedCard.image} style={{ width: '100%', height: '100px' }}  />
