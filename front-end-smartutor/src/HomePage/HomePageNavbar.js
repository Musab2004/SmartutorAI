...
const HomePageNavbar = ({activeTab}) => {
 ...
 ;
  ...
  <Nav.Link
    ...
    style={{ borderBottom: activeTab === 'createstudyplan' ? '4px solid #1f5692' : 'none' }}
...
<Nav.Item>
  <Nav.Link
    ...
    style={{ borderBottom: activeTab === 'my-courses' ? '4px solid #1f5692' : 'none' }}
...
<Nav.Item>
  <Nav.Link
    ...
    style={{ borderBottom: activeTab === 'explore-courses' ? '4px solid #1f5692' : 'none' }}
  ...
  >
   ...
   {userData && <Dropdown.Toggle variant="light" id="dropdown-basic">
      <img
        src={defaultUser}
        height="25"
        alt=""
    ...
    <Dropdown.Menu>
  <Link className="dropdown-item" to="/profile"  onClick={() => handleTabChange('profile')}>
    Profile
  </Link>
